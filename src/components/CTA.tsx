  ...
  return (
    <section className="relative overflow-hidden bg-primary-600 py-20 sm:py-24">
      ...
      <div className="absolute inset-0">
        <div className="absolute -top-24 -right-24 h-96 w-96 rounded-full bg-primary-500/50 blur-3xl" />
        <div className="absolute -bottom-24 -left-24 h-96 w-96 rounded-full bg-primary-700/50 blur-3xl" />
      </div>
