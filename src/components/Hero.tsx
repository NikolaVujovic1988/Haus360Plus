      ...
      <div className="relative mx-auto flex max-w-7xl flex-col items-center px-4 pt-32 pb-20 sm:px-6 lg:flex-row lg:gap-16 lg:px-8 lg:pt-40 lg:pb-32">
        ...
        <div className="max-w-2xl text-center lg:text-left">
          ...
          <h1 className="font-[family-name:var(--font-dm-serif)] text-4xl leading-tight tracking-tight text-foreground sm:text-5xl lg:text-6xl">
            Sauber, gepflegt &{" "}
            <span className="text-primary-600">sorgenfrei</span> —{" "}
            <span className="text-primary-700">das</span> ist unser
            Versprechen.
          </h1>
          ...
          <div className="mt-8 flex flex-col items-center gap-4 sm:flex-row lg:justify-start">
            <Link
              href="#kontakt"
              className="flex w-full items-center justify-center gap-2 rounded-full bg-primary-600 px-8 py-4 text-base font-semibold text-white shadow-lg transition-all hover:bg-primary-700 hover:shadow-xl sm:w-auto"
            >
